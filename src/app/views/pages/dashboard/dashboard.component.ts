...
export class DashboardComponent implements OnInit {
  ...
  /**
   * Parejas nuevas chart options
   */
  getCustomersChartOptions(themeVariables: ThemeCssVariablesType) {
    return {
      series: [{
        name: '',
        data: [22, 24, 21, 26, 23, 25, 22, 24, 26, 23, 25]
      }],
      chart: {
        type: "line",
        height: 60,
  ...
  /**
   * Reservas confirmadas chart options
   */
  getOrdersChartOptions(themeVariables: ThemeCssVariablesType) {
    return {
      series: [{
        name: '',
        data: [16, 18, 15, 20, 19, 17, 21, 18, 19, 16, 20]
      }],
      chart: {
        type: "bar",
        height: 60,
  ...
  /**
   * Satisfacción chart options
   */
  getGrowthChartOptions(themeVariables: ThemeCssVariablesType) {
    return {
      series: [{
        name: '',
        data: [92, 93, 94, 95, 94, 96, 95, 96, 97, 96, 97]
      }],
      chart: {
        type: "line",
        height: 60,
  ...
  /**
   * Ingresos por bodas chart options
   */
  ...
  /**
   * Eventos mensuales chart options
   */
  getMonthlySalesChartOptions(themeVariables: ThemeCssVariablesType) {
    return {
      series: [{
        name: 'Eventos',
        data: [12, 8, 10, 14, 18, 22, 26, 20, 15, 16, 18, 19]
      }],
      chart: {
        type: 'bar',
        height: '330',
  ...
  /**
   * Capacidad de eventos chart options
   */
